...
const DadLedgerPage = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 p-8 lg:p-12 transition-colors duration-300">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Big Balance Card */}
        <div className="bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-950/40 dark:to-zinc-900 border border-indigo-200 dark:border-indigo-500/20 rounded-2xl p-8 mb-12 flex items-center justify-between relative overflow-hidden shadow-sm dark:shadow-none">
